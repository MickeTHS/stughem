  ...
  <section class="about" id="about" :style="{background: section.background}">
    <v-container>
        <v-layout row wrap>
            ...
            <v-flex xs6>
                <v-img
                    :src="section.data[0].image_url == null ? process.env.VUE_APP_CONTENT_URL + '/data/sunset.jpg' : section.data[0].image_url"
                    lazy-src="https://picsum.photos/id/11/10/6"
                    class="grey lighten-2"
                    aspect-ratio="2"
                ><i class="material-icons add add-photo" :section="section" @click="addImageToSection" :style="{background: site.frontend_opts.theme.primary}">add</i></v-img>
